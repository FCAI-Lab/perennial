(* autogenerated from github.com/goose-lang/goose/testdata/examples/channel/elimination_stack *)
Require Export New.code.sync.
Require Export New.code.time.
From New.golang Require Import defn.
Module pkg_id.
Definition elimination_stack : go_string := "github.com/goose-lang/goose/testdata/examples/channel/elimination_stack".

End pkg_id.
Export pkg_id.
Module elimination_stack.

Definition LockedStack {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/goose-lang/goose/testdata/examples/channel/elimination_stack.LockedStack"%go [].

#[global] Opaque LockedStack.

Definition EliminationStack {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/goose-lang/goose/testdata/examples/channel/elimination_stack.EliminationStack"%go [].

#[global] Opaque EliminationStack.

Definition timeout {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W64 10000).

Definition NewLockedStack {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel/elimination_stack.NewLockedStack"%go.

Definition NewEliminationStack {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel/elimination_stack.NewEliminationStack"%go.
