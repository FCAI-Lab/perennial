(* autogenerated from github.com/goose-lang/goose/testdata/examples/channel/lock *)
Require Export New.code.time.
From New.golang Require Import defn.
Module pkg_id.
Definition lock : go_string := "github.com/goose-lang/goose/testdata/examples/channel/lock".

End pkg_id.
Export pkg_id.
Module lock.

Definition Lock {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/goose-lang/goose/testdata/examples/channel/lock.Lock"%go [].

#[global] Opaque Lock.

Definition NewLock {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel/lock.NewLock"%go.
