(* autogenerated from github.com/goose-lang/goose/testdata/examples/channel/parallel_search_replace *)
Require Export New.code.sync.
From New.golang Require Import defn.
Module pkg_id.
Definition parallel_search_replace : go_string := "github.com/goose-lang/goose/testdata/examples/channel/parallel_search_replace".

End pkg_id.
Export pkg_id.
Module parallel_search_replace.

Definition worker {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel/parallel_search_replace.worker"%go.

Definition SearchReplace {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel/parallel_search_replace.SearchReplace"%go.
