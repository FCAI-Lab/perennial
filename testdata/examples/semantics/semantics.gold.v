...
Definition testCompareAllⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := #false in
    do:  ("nok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(1 <⟨go.untyped int⟩ 2)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(2 <⟨go.untyped int⟩ 1)) in
    do:  ("nok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(1 ≤⟨go.untyped int⟩ 2)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(2 ≤⟨go.untyped int⟩ 2)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(2 ≤⟨go.untyped int⟩ 1)) in
    do:  ("nok" <-[go.bool] "$r0");;;
    (if: ![go.bool] "nok"
...
Definition testCopySimpleⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    return: ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "y") #(W64 3))) =⟨go.byte⟩ #(W8 1))).
...
Definition testCopyShorterDstⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    do:  ("n" <-[go.uint64] "$r0");;;
    return: (((![go.uint64] "n") =⟨go.uint64⟩ #(W64 10)) && ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "y") #(W64 3))) =⟨go.byte⟩ #(W8 1)))).
...
Definition testCopyShorterSrcⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    (FuncResolve go.copy [go.SliceType go.byte] #()) "$a0" "$a1")) in
    do:  ("n" <-[go.uint64] "$r0");;;
    return: ((((![go.uint64] "n") =⟨go.uint64⟩ #(W64 10)) && ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "y") #(W64 3))) =⟨go.byte⟩ #(W8 1))) && ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "y") #(W64 12))) =⟨go.byte⟩ #(W8 2)))).
...
Definition roundtripEncDec32ⁱᵐᵖˡ : val :=
  λ: "x",
    ...
    let: "$r0" := (go.AllocValue Enc (let: "$p" := (![go.SliceType go.byte] "r") in
    CompositeLiteral Enc (
      let: "$$vs" := go.StructElementListNil #() in 
    ...
    let: "$r0" := (go.AllocValue Dec (let: "$p" := (![go.SliceType go.byte] "r") in
    CompositeLiteral Dec (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$p" in
      "$$vs"
    ))) in
...
Definition failing_testEncDec32ⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    (FuncResolve roundtripEncDec32 [] #()) "$a0") =⟨go.uint32⟩ #(W32 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((let: "$a0" := (4294967296 -⟨go.untyped int⟩ 1) in
    (FuncResolve roundtripEncDec32 [] #()) "$a0") =⟨go.uint32⟩ (4294967296 -⟨go.untyped int⟩ 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testEncDec64ⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    (FuncResolve roundtripEncDec64 [] #()) "$a0") =⟨go.uint64⟩ #(W64 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((let: "$a0" := (18446744073709551616 -⟨go.untyped int⟩ 1) in
    (FuncResolve roundtripEncDec64 [] #()) "$a0") =⟨go.uint64⟩ (18446744073709551616 -⟨go.untyped int⟩ 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition Editor__AdvanceReturnⁱᵐᵖˡ : val :=
  λ: "e" "next",
    ...
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] (StructFieldRef Editor "s"%go (![go.PointerType Editor] "e"))) #(W64 0)) <-[go.uint64] "$r0");;;
...
Definition failing_testFunctionOrderingⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    CompositeLiteral Editor (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$s" in
      let: "$$vs" := go.ElementListApp "$$vs" "$next_val" in
      "$$vs"
    )) in
    do:  ("e1" <-[Editor] "$r0");;;
    ...
    do:  ("e2" <-[Editor] "$r0");;;
    (if: ((let: "$a0" := #(W64 2) in
    (MethodResolve (go.PointerType Editor) AdvanceReturn #() "e1") "$a0") +⟨go.uint64⟩ (let: "$a0" := #(W64 102) in
    (MethodResolve (go.PointerType Editor) AdvanceReturn #() "e2") "$a0")) ≠⟨go.uint64⟩ #(W64 102)
    then return: (#false)
    else do:  #());;;
    (if: (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 0))) ≠⟨go.uint64⟩ #(W64 101)
    then return: (#false)
    else do:  #());;;
    ...
    (if: (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 1))) ≠⟨go.uint64⟩ #(W64 102)
    then return: (#false)
    else do:  #());;;
    (if: (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 2))) ≠⟨go.uint64⟩ #(W64 3)
    then return: (#false)
    else do:  #());;;
    ...
    (MethodResolve (go.PointerType Editor) AdvanceReturn #() "e2") "$a0") in
    CompositeLiteral Pair (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$x" in
      let: "$$vs" := go.ElementListApp "$$vs" "$y" in
      "$$vs"
    )) in
    do:  ("p" <-[Pair] "$r0");;;
    (if: (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 3))) ≠⟨go.uint64⟩ #(W64 104)
    then return: (#false)
    else do:  #());;;
    ...
    do:  ("q" <-[Pair] "$r0");;;
    (if: (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 4))) ≠⟨go.uint64⟩ #(W64 105)
    then return: (#false)
    else do:  #());;;
...
Definition measureAreaⁱᵐᵖˡ : val :=
  λ: "t",
    ...
    return: ((MethodResolve geometryInterface Square #() (![geometryInterface] "t")) #())).
...
Definition measureVolumePlusNMⁱᵐᵖˡ : val :=
  λ: "t" "n" "m",
    ...
    return: ((((MethodResolve geometryInterface Volume #() (![geometryInterface] "t")) #()) +⟨go.uint64⟩ (![go.uint64] "n")) +⟨go.uint64⟩ (![go.uint64] "m"))).
...
Definition measureVolumeⁱᵐᵖˡ : val :=
  λ: "t",
    exception_do (let: "t" := (go.AllocValue geometryInterface "t") in
    return: ((MethodResolve geometryInterface Volume #() (![geometryInterface] "t")) #())).
...
Definition testBasicInterfaceⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    CompositeLiteral SquareStruct (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$Side" in
      "$$vs"
    )) in
...
Definition testStandardForLoopⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    do:  ("arr" <-[go.SliceType go.uint64] "$r0");;;
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 0)) <-[go.uint64] ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 0))) +⟨go.uint64⟩ #(W64 1)));;;
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 1)) <-[go.uint64] ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 1))) +⟨go.uint64⟩ #(W64 3)));;;
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 2)) <-[go.uint64] ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 2))) +⟨go.uint64⟩ #(W64 5)));;;
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 3)) <-[go.uint64] ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 3))) +⟨go.uint64⟩ #(W64 7)));;;
...
Definition testForLoopWaitⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    CompositeLiteral LoopStruct (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$loopNext" in
      "$$vs"
    )) in
    do:  ("ls" <-[LoopStruct] "$r0");;;
    do:  (let: "$a0" := #(W64 3) in
...
Definition testSub64Equalsⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$a2" := (9223372036854775808 -⟨go.untyped int⟩ 1) in
    (FuncResolve sub64Equals [] #()) "$a0" "$a1" "$a2")) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && (let: "$a0" := #(W64 2) in
    let: "$a1" := #(W64 8) in
    let: "$a2" := (18446744073709551616 -⟨go.untyped int⟩ 6) in
    (FuncResolve sub64Equals [] #()) "$a0" "$a1" "$a2")) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testDivisionPrecedenceⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := (((![go.uint64] "blockSize") -⟨go.uint64⟩ (![go.uint64] "hdrmeta")) `quot`⟨go.uint64⟩ #(W64 8)) in
...
Definition testModPrecedenceⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := (513 +⟨go.untyped int⟩ (12 `rem`⟨go.untyped int⟩ 8)) in
    do:  ("x1" <-[go.int] "$r0");;;
...
Definition testBitwiseOpsPrecedenceⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := #true in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(479 =⟨go.untyped int⟩ 479)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(132 =⟨go.untyped int⟩ 132)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(828 =⟨go.untyped int⟩ 828)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(893 =⟨go.untyped int⟩ 893)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(461 =⟨go.untyped int⟩ 461)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && (479 ≠⟨go.untyped int⟩ 389)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testArithmeticShiftsⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := #true in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(5376 =⟨go.untyped int⟩ 5376)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(1513209474796486656 =⟨go.untyped int⟩ 1513209474796486656)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(42 =⟨go.untyped int⟩ 42)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(0 =⟨go.untyped int⟩ 0)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && #(672 =⟨go.untyped int⟩ 672)) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testBitAddAndⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := #(W64 16) in
    do:  ("n" <-[go.uint64] "$r0");;;
    return: ((((![go.uint64] "tid") +⟨go.uint64⟩ (![go.uint64] "n")) `and` (~ ((![go.uint64] "n") -⟨go.uint64⟩ #(W64 1)))) =⟨go.uint64⟩ #(W64 32))).
...
Definition testManyParenthesesⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (#((3 *⟨go.untyped int⟩ 6) =⟨go.untyped int⟩ (3 *⟨go.untyped int⟩ 6)))).
...
Definition testPlusTimesⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (#(((2 +⟨go.untyped int⟩ 5) *⟨go.untyped int⟩ 2) =⟨go.untyped int⟩ 14))).
...
Definition testOrCompareSimpleⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do ((if: #(3 >⟨go.untyped int⟩ 4) || #(4 >⟨go.untyped int⟩ 3)
    then return: (#true)
    else do:  #());;;
    return: (#false)).
...
Definition testOrCompareⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := #true in
    do:  ("ok" <-[go.bool] "$r0");;;
    (if: (~ (#(3 >⟨go.untyped int⟩ 4) || #(4 >⟨go.untyped int⟩ 3)))
    then
      let: "$r0" := #false in
      do:  ("ok" <-[go.bool] "$r0")
    else do:  #());;;
    (if: #(4 <⟨go.untyped int⟩ 3) || #(2 >⟨go.untyped int⟩ 3)
    then
      let: "$r0" := #false in
      do:  ("ok" <-[go.bool] "$r0")
    else do:  #());;;
...
Definition testShiftModⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (#(20 =⟨go.untyped int⟩ 20))).
...
Definition testShortcircuitAndTFⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := (go.AllocValue BoolTest (let: "$t" := #true in
    let: "$f" := #false in
    let: "$tc" := #(W64 0) in
    let: "$fc" := #(W64 0) in
    CompositeLiteral BoolTest (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$t" in
      let: "$$vs" := go.ElementListApp "$$vs" "$f" in
      let: "$$vs" := go.ElementListApp "$$vs" "$tc" in
      let: "$$vs" := go.ElementListApp "$$vs" "$fc" in
      "$$vs"
    ))) in
...
Definition ArrayEditor__Advanceⁱᵐᵖˡ : val :=
  λ: "ae" "arr" "next",
    ...
    do:  ((slice.elem_ref go.uint64 (![go.SliceType go.uint64] (StructFieldRef ArrayEditor "s"%go (![go.PointerType ArrayEditor] "ae"))) #(W64 0)) <-[go.uint64] "$r0");;;
    let: "$r0" := (![go.uint64] "next") in
...
Definition testSliceOpsⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "v2") #(W64 0))) =⟨go.uint64⟩ #(W64 10))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((let: "$a0" := (![go.SliceType go.uint64] "v2") in
    (FuncResolve go.len [go.SliceType go.uint64] #()) "$a0") =⟨go.int⟩ #(W64 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "v3") #(W64 1))) =⟨go.uint64⟩ #(W64 5))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "v3") #(W64 2))) =⟨go.uint64⟩ #(W64 10))) in
    do:  ("ok" <-[go.bool] "$r0");;;
...
Definition testSliceCapacityOpsⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    slice.slice go.uint64 "$s" #(W64 0) #(W64 10)) #(W64 0))) =⟨go.uint64⟩ #(W64 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    ...
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.uint64] (slice.elem_ref go.uint64 (let: "$s" := (![go.SliceType go.uint64] "x") in
    slice.slice go.uint64 "$s" #(W64 0) #(W64 10)) #(W64 2))) =⟨go.uint64⟩ #(W64 2))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testOverwriteArrayⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := (go.AllocValue ArrayEditor (let: "$s" := (let: "$s" := (![go.SliceType go.uint64] "arr") in
    slice.slice go.uint64 "$s" #(W64 0) (slice.len "$s")) in
    let: "$next_val" := #(W64 1) in
    CompositeLiteral ArrayEditor (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$s" in
      let: "$$vs" := go.ElementListApp "$$vs" "$next_val" in
      "$$vs"
    ...
    let: "$a1" := #(W64 5) in
    (MethodResolve (go.PointerType ArrayEditor) Advance #() (![go.PointerType ArrayEditor] "ae1")) "$a0" "$a1");;;
    (if: ((((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 0))) +⟨go.uint64⟩ (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 1)))) +⟨go.uint64⟩ (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 2)))) +⟨go.uint64⟩ (![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 3)))) ≥⟨go.uint64⟩ #(W64 100)
    then return: (#false)
    else do:  #());;;
    return: (((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 3))) =⟨go.uint64⟩ #(W64 4)) && ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "arr") #(W64 0))) =⟨go.uint64⟩ #(W64 4)))).
...
Definition testSliceLiteralⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$sl1" := #(W8 2) in
    CompositeLiteral go.byte go.byte ["$sl0"; "$sl1"])) in
    do:  ("bytes" <-[go.SliceType go.byte] "$r0");;;
    let: "ok" := (GoAlloc go.bool #()) in
    let: "$r0" := #true in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "bytes") #(W64 0))) =⟨go.byte⟩ #(W8 1))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "ints" := (GoAlloc (go.SliceType go.uint64) #()) in
    let: "$r0" := ((let: "$sl0" := #(W64 1) in
    let: "$sl1" := #(W64 2) in
    let: "$sl2" := #(W64 3) in
    CompositeLiteral go.uint64 go.uint64 ["$sl0"; "$sl1"; "$sl2"])) in
    do:  ("ints" <-[go.SliceType go.uint64] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.uint64] (slice.elem_ref go.uint64 (![go.SliceType go.uint64] "ints") #(W64 1))) =⟨go.uint64⟩ #(W64 2))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testSliceAppendⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    do:  ("ok" <-[go.bool] "$r0");;;
    let: "$r0" := ((![go.bool] "ok") && ((![go.byte] (slice.elem_ref go.byte (![go.SliceType go.byte] "bytes") #(W64 2))) =⟨go.byte⟩ #(W8 3))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition Foo__mutateBarⁱᵐᵖˡ : val :=
  λ: "foo" <>,
    ...
    do:  ((MethodResolve (go.PointerType Bar) mutate #() (StructFieldRef Foo "bar"%go (![go.PointerType Foo] "foo"))) #());;;
    return: #()).
...
Definition testFooBarMutationⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$b" := #(W64 0) in
    CompositeLiteral Bar (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$a" in
      let: "$$vs" := go.ElementListApp "$$vs" "$b" in
      "$$vs"
    )) in
    CompositeLiteral Foo (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$bar" in
      "$$vs"
    )) in
    do:  ("x" <-[Foo] "$r0");;;
...
Definition NewSⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (go.AllocValue S (let: "$a" := #(W64 2) in
     let: "$b" := (let: "$x" := #(W64 1) in
     let: "$y" := #(W64 2) in
     CompositeLiteral TwoInts (
       let: "$$vs" := go.StructElementListNil #() in 
       let: "$$vs" := go.ElementListApp "$$vs" "$x" in
       let: "$$vs" := go.ElementListApp "$$vs" "$y" in
       "$$vs"
     ...
     CompositeLiteral S (
       ...
       let: "$$vs" := go.ElementListApp "$$vs" "$a" in
       let: "$$vs" := go.ElementListApp "$$vs" "$b" in
       let: "$$vs" := go.ElementListApp "$$vs" "$c" in
       "$$vs"
     )))).
...
Definition testStructUpdatesⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := ((![go.bool] "ok") && (((MethodResolve (go.PointerType S) readA #() (![go.PointerType S] "ns")) #()) =⟨go.uint64⟩ #(W64 2))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    ...
    let: "$r0" := ((![go.bool] "ok") && ((StructFieldGet TwoInts "x" ((MethodResolve (go.PointerType S) readBVal #() (![go.PointerType S] "ns")) #())) =⟨go.uint64⟩ #(W64 4))) in
    do:  ("ok" <-[go.bool] "$r0");;;
    return: (![go.bool] "ok")).
...
Definition testIncompleteStructⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    CompositeLiteral S (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$a" in
      let: "$$vs" := go.ElementListApp "$$vs" (go.ZeroVal TwoInts #()) in
...
Definition testStoreInStructVarⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    CompositeLiteral StructWrap (
      let: "$$vs" := go.StructElementListNil #() in 
      let: "$$vs" := go.ElementListApp "$$vs" "$i" in
      "$$vs"
    )) in
    do:  ("p" <-[StructWrap] "$r0");;;
    let: "$r0" := #(W64 5) in
...
Definition testSwitchConversionⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    let: "$r0" := (go.AllocValue switchConcrete (CompositeLiteral switchConcrete (
      let: "$$vs" := go.StructElementListNil #() in 
      "$$vs"
    ))) in
...
Definition disabled_testWalⁱᵐᵖˡ : val :=
  λ: <>,
    ...
    (MethodResolve disk.Disk Read #() (![disk.Disk] (StructFieldRef Log "d"%go "lg"))) "$a0") in
